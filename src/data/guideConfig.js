export const guideConfig = {
  ...
  categories: [
    ...
    { id: 'saude', name: 'Saúde', icon: 'Hospital' },
  ...
  places: [
    ...
    {
      id: 11,
      name: "Lavanderia Express Washwise Vitta Center",
      category: "utilitarios",
    ...
    {
      id: 14,
      name: "Restaurante Carreras",
      category: "restaurantes",
      subcategory: "Restaurantes",
      display: "both",
      coords: [-29.69278815540534, -53.802701330288976],
    ...
    },
    {
      ...
      subcategory: "Xis",
      display: "list",
      description: "Xis raiz de excelente qualidade. Somente tele-entrega.",
      links: {
        url: "https://www.instagram.com/xisdofabio/",
        label: "Ver cardápio",
        type: "instagram"
      }
    },
    ...
    {
      id: 20,
      name: "Hospital de Caridade Astrogildo de Azevedo",
      category: "saude",
